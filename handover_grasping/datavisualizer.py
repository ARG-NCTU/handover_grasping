...
__all__ = ['handover_grasping_dataset', 'rosenberger_dataloader', 'parallel_jaw_based_grasping_dataset']
...
class handover_grasping_dataset(Dataset):
    ...
    Returns:
        A dict
    """
    def __init__(self, data_dir, mode='train', color_type='jpg', depth_type='npy', HANet_d=False, Zeng=False):
        ...
        if mode != 'fl_test' and self.had2 != True:
            f = open(self.data_dir+"/"+self.mode+".txt", "r")
        elif mode != 'fl_test' and self.had2 == True:
    ...
    def __getitem__(self, idx):
        ...
        if self.had2 == False:
            ...
            depth_origin = cv2.imread(self.data_dir+"/heightmap-depth/"+idx_name+'.png', -1).astype(float)
            depth_origin = cv2.resize(depth_origin,(640,480))
...
#             depth_origin = depth_origin[:,:,0]
        ...
        if self.had2 == False:
            ...
            label_img = np.load(self.data_dir+"/HA_label/"+idx_name+'.npy')

            f = open(self.data_dir+'/idx/'+idx_name+'.txt', "r")
